...
class PanguEmbeddedForCausalLM(PanguEmbeddedPreTrainedModel, GenerationMixin):
    ...
    # ! ------ steering ------
    def set_steering_flag(self, steering_flag, steering_layer=None, steer_vec=None, steer_coef=0.0, tokenizer=None, q25=None, q75=None, low_val=None, tau=None):
        ...
        if self.steering_flag and getattr(self, "_dyn_enabled", True):
            ...
            if ready_mask.any():
                ...
                def _solve_k_for_tau(q25, q75, low_val, high_val, tau, iters=80):
                    ...
                    def ratio(k):
                        num = math.tanh(k * max(0.0, 1.0 - m))
                        ks = k * s
                        den = math.tanh(ks) if ks > 1e-12 else ks
